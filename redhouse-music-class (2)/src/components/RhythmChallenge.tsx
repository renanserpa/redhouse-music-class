    ...
    if (isPlaying) {
      ...
      timerRef.current = setInterval(() => {
        setCurrentBeat(prev => {
          ...
          if (beat.type === 'clap') audio.playTone(440, 'sine', 0.1, 0.1);
          else if (beat.type === 'stomp') audio.playTone(220, 'triangle', 0.1, 0.2);
          else if (beat.type === 'snap') audio.playTone(880, 'sine', 0.05, 0.05);
