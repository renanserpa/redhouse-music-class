...
export default function Metronome() {
  ...
  return (
    <section className="bg-white rounded-[40px] p-8 shadow-xl border-4 border-slate-900 overflow-hidden relative">
      ...
      <header className="flex items-center justify-between mb-10 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-2xl font-black uppercase italic">Metrônomo Rockstar</h3>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Mantenha o Pulso Firme</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center">
          <div className="relative mb-10">
            <motion.div 
              ...
              className="w-64 h-64 bg-slate-50 rounded-full border-8 border-slate-900 flex flex-col items-center justify-center shadow-2xl relative"
            >
              <span className="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">BPM</span>
              <motion.span 
                animate={isPlaying ? { 
                  color: currentBeat === 0 ? '#f97316' : '#0f172a',
                  scale: [1, 1.05, 1]
                } : {}}
          ...
          <div className="flex items-center gap-6 mb-10">
            <button 
              onClick={() => changeBpm(-5)}
              className="w-14 h-14 bg-white border-4 border-slate-900 rounded-2xl flex items-center justify-center text-slate-900 hover:bg-slate-50 active:scale-95 transition-all shadow-lg"
            >
