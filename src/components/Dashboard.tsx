        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl font-black text-redhouse-text uppercase italic tracking-tighter">
            ...
            <div className="flex gap-4">
              <div className="glass-card p-6 bg-white/5 border-white/10 flex flex-col items-center justify-center min-w-[120px]">
                <Zap className="w-6 h-6 text-pedagogy-yellow mb-2" />
                <span className="text-2xl font-black text-redhouse-text italic">{state.xp || 0}</span>
                <span className="text-[10px] font-black text-redhouse-muted uppercase tracking-widest">XP Total</span>
              </div>
              <div className="glass-card p-6 bg-white/5 border-white/10 flex flex-col items-center justify-center min-w-[120px]">
                <Coins className="w-6 h-6 text-pedagogy-yellow mb-2" />
                <span className="text-2xl font-black text-redhouse-text italic">{state.coins || 0}</span>
                <span className="text-[10px] font-black text-redhouse-muted uppercase tracking-widest">Moedas</span>
              </div>
            </div>
          </div>
        </div>
