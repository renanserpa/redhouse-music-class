...
export async function saveLessonReport(report: LessonReport): Promise<void> {
  try {
    ...
    console.log("Lesson Report Saved to Firestore:", report.id);
  } catch (error) {
...
export async function saveMonthlyReport(report: MonthlyReport): Promise<void> {
  try {
    ...
    console.log("Monthly Report Saved to Firestore:", report.id);
  } catch (error) {
...
export async function saveActivityAttempt(attempt: ActivityAttempt): Promise<void> {
  try {
    ...
    console.log("Activity Attempt Saved to Firestore");
  } catch (error) {
...
export async function saveUserProgress(uid: string, xp: number, coins: number): Promise<void> {
  try {
...
export async function getUserProgress(uid: string): Promise<{ xp: number, coins: number } | null> {
  try {
